  ...
  <div class="flex flex-col lg:flex-row justify-between min-h-full">
    ...
    <article class="lg:w-4/5">
      <section class="py-10 px-5 ml-4 md:ml-10 md:px-10 select-none font-serif">
        ...
        <h1 class="text-2xl sm:text-3xl md:text-5xl lg:text-6xl  text-copy-secondary lg:ml-4">Welcome to <span class="font-bold font-sans text-copy-primary">ArachniCMS v1.1.0</span>.</h1>
