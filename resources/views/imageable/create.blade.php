...
@section('css')
  ...
  <link rel="stylesheet" href="{{ asset('css/dim-fcr-s1.css') }}">
@endsection
    ...
    @if($post)
      ...
      @else 
        <p class="mb-4 text-copy-primary text-lg px-8">
          Looks like you haven't uploaded any photos yet! Either that or you've already embedded all available images in this blog post. You have to upload photos to your collection before you can embed them in your blog posts. <a href="/images" class="text-blue-500 underline">Go here</a> to upload images and manage your collection. You can also get there by going to the Admin section.
        </p>
      @endif
    @elseif ($album)
