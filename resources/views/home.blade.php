    ...
    <main class="lg:w-4/5">
      <section class="py-10 px-10 select-none font-serif">
        ...
        <p class="text-xl text-copy-secondary mt-4 md:px-12 md:mr-4 leading-relaxed">
          PocoCMS is a blogging tool developed specifically with musicians in mind. Naturally, the standard blogging tools are available to you. You will also, however, find tools to allow you to manage your discography listings and <span class="italic">even integrate integrate those listings with your blog posts.</span>
        </p>
        <p class="text-xl text-copy-secondary mt-4 md:px-12 md:mr-4 leading-relaxed">
