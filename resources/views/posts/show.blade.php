...
<div id="deleteCommentModal"
  class="fixed z-30 bg-background-primary border text-copy-primary rounded mx-auto max-w-3xl w-11/12 hidden text-center py-4 px-6 container inset-x-0 h-auto my-8 md:my-16">
  <div class="flex flex-row justify-end">
    <button aria-label="close comment deletion modal" type="button" id="dcmCancel"><svg version="1.1"
        class="fill-current h-8 w-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
        xml:space="preserve">
        <path
          d="M16,2H4C2.9,2,2,2.9,2,4v12c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V4C18,2.9,17.1,2,16,2z M13.061,14.789  L10,11.729l-3.061,3.06L5.21,13.061L8.271,10l-3.06-3.061L6.94,5.21L10,8.271l3.059-3.061l1.729,1.729L11.729,10l3.06,3.061  L13.061,14.789z" />
      </svg></button>
  </div>
  <p class="font-bold text-2xl">
    ...
    <form action="/comments" method="post">
      ...
      <button type="submit" id="submitDelete"
        class="bg-background-secondary border text-copy-secondary hover:text-copy-primary font-bold w-5/6 rounded py-2 px-4 mt-4">Delete
        Forever</button>
    </form>
  </p>
</div>
<div id="approveCommentModal"
  class="fixed z-30 bg-background-primary border text-copy-primary rounded mx-auto max-w-3xl w-11/12 hidden text-center py-4 px-6 container inset-x-0 h-auto my-8 md:my-16">
  <div class="flex flex-row justify-end">
    <button aria-label="close comment approval modal" type="button" id="acmCancel"><svg version="1.1"
        class="fill-current h-8 w-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
        xml:space="preserve">
        <path
  ...
  <p class="font-bold text-2xl">
    ...
    <form action="/comments" method="post">
      ...
      <button type="submit" id="submitApproval"
        class="bg-background-secondary border text-copy-secondary hover:text-copy-primary font-bold w-5/6 rounded py-2 px-4 mt-4">Approve
        Comment</button>
    </form>
  </p>
</div>
<div id="unapproveCommentModal"
  class="fixed z-30 bg-background-primary border text-copy-primary rounded mx-auto max-w-3xl w-11/12 hidden text-center py-4 px-6 container inset-x-0 h-auto my-8 md:my-16">
  <div class="flex flex-row justify-end">
    <button aria-label="close comment unapproval modal" type="button" id="ucmCancel"><svg version="1.1"
        class="fill-current h-8 w-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
        xml:space="preserve">
        <path
  ...
  <p class="font-bold text-2xl">
    ...
    <form action="/comments" method="post">
      ...
      <button type="submit" id="submitUnapproval"
        class="bg-background-secondary border text-copy-secondary hover:text-copy-primary font-bold w-5/6 rounded py-2 px-4 mt-4">Unapprove
        Comment</button>
    </form>
  </p>
</div>
<div class="fixed inset-0 bg-black z-20 hidden max-h-screen" id="image-gallery">
  <div class="flex flex-row justify-end py-2 px-4">
    <button aria-label="close modal for viewing large version of image" type="button" id="big-img-cancel"><svg
        version="1.1" class="fill-current text-copy-primary h-5 w-5 cursor-pointer" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
        xml:space="preserve">
        <path
          d="M16,2H4C2.9,2,2,2.9,2,4v12c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V4C18,2.9,17.1,2,16,2z M13.061,14.789  L10,11.729l-3.061,3.06L5.21,13.061L8.271,10l-3.06-3.061L6.94,5.21L10,8.271l3.059-3.061l1.729,1.729L11.729,10l3.06,3.061  L13.061,14.789z" />
  ...
  <p
    class="w-full bg-background-secondary rounded px-4 py-2 text-copy-primary hover:text-copy-secondary cursor-default">
...
<div class="max-w-2xl w-10/12 mt-8 mx-auto flex 
    ...
    @endguest
  ">
  <a href="/posts" aria-label="Back to List of Blog Posts"
    class="border bg-background-primary text-copy-secondary py-2 px-4 rounded hover:bg-background-secondary font-bold h-auto inline-block mx-2 my-2 sm:my-0">
    <svg version="1.1" class="fill-current h-8 w-8" xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
      xml:space="preserve">
      <path
  ...
  @auth
  <a href="/imageables/post/{{ $post->url_string }}/create" aria-label="embed photos in this blog post"
    class="border bg-background-primary text-copy-secondary py-2 px-4 rounded hover:bg-background-secondary font-bold h-auto flex flex-row justify-center items-center mx-2 my-2 sm:my-0">
    <svg version="1.1" class="fill-current h-8 w-8" xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
      xml:space="preserve">
      <path
  ...
  <a href="/youtubevidembeds/{{ $post->url_string }}" aria-label="embed youtube videos in this blog post"
    class="border bg-background-primary text-copy-secondary py-2 px-4 rounded hover:bg-background-secondary font-bold h-auto flex flex-row justify-center items-center mx-2 my-2 sm:my-0">
    <svg version="1.1" class="fill-current h-8 w-8" xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
      xml:space="preserve">
  ...
  <a href="/posts/{{ $post->url_string }}/edit" aria-label="edit this blog post"
    class="border bg-background-primary text-copy-secondary py-2 px-4 rounded hover:bg-background-secondary font-bold h-auto inline-block mx-2 my-2 sm:my-0">
    <svg version="1.1" class="fill-current h-8 w-8" xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
      xml:space="preserve">
...
<article
  class="w-full sm:max-w-2xl sm:w-10/12 bg-background-primary shadow-lg rounded mx-auto px-3 md:px-8 pt-6 pb-8 mt-8 relative {{ $settings->font_pref == 'gsa' ? 'font-sans' : '' }} {{ $settings->font_pref == 'gsa' ? 'font-sans' : '' }} {{ $settings->font_pref == 'gse' ? 'font-serif' : '' }} {{ $settings->font_pref == 'gmo' ? 'font-mono' : '' }} {{ $settings->font_pref == 'asa' ? 'font-alegreya-sans' : '' }} {{ $settings->font_pref == 'ase' ? 'font-alegreya' : '' }} {{ $settings->font_pref == 'fco' ? 'font-fira-code' : '' }} {{ $settings->font_pref == 'hac' ? 'font-hack' : '' }} {{ $settings->font_pref == 'mon' ? 'font-montserrat' : '' }} {{ $settings->font_pref == 'qui' ? 'font-quicksand' : '' }}">
  <div class="flex flex-row">
    <h1
      class="font-semibold text-2xl text-copy-primary mb-4 {{ $settings->font_pref == 'asa' ? 'font-alegreya-sans-sc' : '' }} {{ $settings->font_pref == 'ase' ? 'font-alegreya-sc' : '' }}">
      {{ $post->title }}
    </h1>
  </div>
  @if(count($post->images))
  <div class="my-6 w-full overflow-x-auto px-2 rounded bg-background-secondary flex flex-row ">
    ...
    <img src="/storage/img/{{ $image->location }}" alt="{{ $image->description }}"
      class="thumbnail w-1/4 mx-2 cursor-pointer flex-shrink-0">
    @endforeach
  </div>
  @endif
  <dl class="my-4 cursor-default flex flex-row flex-wrap justify-around">
    ...
    <dd
      class="border w-auto bg-background-secondary text-copy-primary hover:text-copy-secondary font-semibold rounded-full py-2 px-4 text-sm mx-4 my-2 mx-auto">
      {{ $post->is_published ? 'Published' : 'Unpublished' }}</dd>
    <dt class="sr-hidden">View Count</dt>
    <dd
      class="border w-auto bg-background-secondary text-copy-primary hover:text-copy-secondary font-semibold rounded-full py-2 px-4 text-sm flex flex-row items-center align-center mx-4 my-2 mx-auto">
      <svg version="1.1" class="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20"
        xml:space="preserve">
        <path
  ...
  <section id="post-body"
    class="text-copy-primary mx-2 md:mx-6 my-4 {{ $settings->text_selection_policy ? '' : 'select-none' }}">
    {!! $post->body !!}
  </section>
  <section class="mb-8 mx-6">
    @foreach($post->youtubevidembeds as $embed)
    <div class="mb-8 videoWrapper absolute w-full h-0">
      <iframe nonce="{{ csp_nonce() }}" width="560" height="349"
        src="https://www.youtube.com/embed/{{ $embed->youtubevidcode->vidcode }}" frameborder="0"
  ...
  <section class="text-copy-secondary bg-background-secondary border px-6 py-6 rounded-lg mx-6 my-4">
    ...
    <form action="/subscriptions" method="post" class="flex flex-col items-start justify-between">
      ...
      <input type="email" name="email" id="subscription-email"
        class="text-copy-primary bg-background-form shadow appearance-none border rounded w-full py-2 px-3 text-copy-primary leading-tight focus:outline-none focus:shadow-outline focus:bg-background-ruthieslight @error('email') border-solid border-red-600 border-2 @enderror"
        value="{{ old('email') }}" required>
      <button type="submit"
        class="border bg-background-primary text-copy-secondary py-2 px-4 rounded hover:text-copy-primary font-bold mt-4">Subscribe</button>
    </form>
  </section>
  @endif
  <section class="mb-8 mx-6 text-copy-primary">
    ...
    <div class="flex flex-row justify-around">
      <a href="https://www.facebook.com/sharer.php?u={{ url()->current() }}" aria-label="Share this post on Facebook">
  ...
  <section class="px-6 py-6 mx-auto my-4 w-5/6">
    ...
    @elseif($settings->patreon_url == null)
...
<article
  class="max-w-2xl w-10/12 bg-background-primary shadow-lg rounded mx-auto pt-6 pb-8 mt-8 font-sans relative {{ $settings->font_pref == 'gsa' ? 'font-sans' : '' }} {{ $settings->font_pref == 'gsa' ? 'font-sans' : '' }} {{ $settings->font_pref == 'gse' ? 'font-serif' : '' }} {{ $settings->font_pref == 'gmo' ? 'font-mono' : '' }} {{ $settings->font_pref == 'asa' ? 'font-alegreya-sans' : '' }} {{ $settings->font_pref == 'ase' ? 'font-alegreya' : '' }} {{ $settings->font_pref == 'fco' ? 'font-fira-code' : '' }} {{ $settings->font_pref == 'hac' ? 'font-hack' : '' }} {{ $settings->font_pref == 'mon' ? 'font-montserrat' : '' }} {{ $settings->font_pref == 'qui' ? 'font-quicksand' : '' }}">
  <section class="flex flex-col items-start px-8">
    ...
    <div class="mb-4 text-copy-primary flex flex-col">
      ...
      <p>Feel free to leave a respectful comment. All comments, without exception, are subject to a manual approval
        process. If you misbehave and fail to act like a decent person, you will be banned from the site.</p>
      @else
      ...
      @auth
      @if($post->comments_locked)
      <p>Looks like you have comments locked on this post. You can still comment, but your visitors won't be able to.
      </p>
      @else
      <p>Here, visitors to your site will see a warning that admonishes them to be respectful and decent when
        commenting. It also warns them that they can be banned if they fail to do so.</p>
      @endif
      @endauth
    </div>
    <p class="mb-4 text-copy-primary">
      ...
      @endauth
      @guest
      Only comments that have been manually approved are shown below. If yours is awaiting approval, thank you for your
      patience!
      @endguest
    </p>
  </section>
  ...
  <form action="/comments" method="post" class="px-8 pb-10">
    ...
    <div class="flex flex-col items-start mt-4 text-copy-secondary">
      ...
      <textarea name="body" id="body" required
        class="text-copy-primary bg-background-form shadow appearance-none border rounded w-full py-2 px-3 text-copy-primary leading-tight focus:outline-none focus:shadow-outline focus:bg-background-ruthieslight @error('body') border-solid border-red-600 border-2 @enderror">{{ old('body') }}</textarea>
    </div>
    <button type="submit"
      class="border bg-background-secondary text-copy-secondary py-2 px-4 rounded hover:bg-background-primary font-bold mt-4">Submit</button>
  </form>
  @endauth
  @guest
  @if(!$post->comments_locked)
  <form action="/comments" method="post" class="px-8 pb-10">
    ...
    <div class="flex flex-col items-start">
      ...
      <input type="text" name="name" id="name" required
        class="text-copy-primary bg-background-form shadow appearance-none border rounded w-full py-2 px-3 text-copy-primary leading-tight focus:outline-none focus:shadow-outline focus:bg-background-ruthieslight @error('name') border-solid border-red-600 border-2 @enderror"
        value="{{ old('name') }}">
    </div>
  ...
  <section class="">
    ...
    <div
      class="mb-4 flex flex-col justify-center items-center text-copy-primary hover:text-copy-secondary cursor-pointer w-auto">
      <p
        class="text-xl font-bold text-copy-primary {{ $settings->font_pref == 'asa' ? 'font-alegreya-sans-sc' : '' }} {{ $settings->font_pref == 'ase' ? 'font-alegreya-sc' : '' }}">
        Unapproved</p>
      <div class="flex flex-row mt-2">
        ...
        <svg version="1.1" class="fill-current h-8 w-8" xmlns="http://www.w3.org/2000/svg"
          ...
          enable-background="new 0 0 20 20" xml:space="preserve">
          <path
            d="M5.8,12.2V6H2C0.9,6,0,6.9,0,8v6c0,1.1,0.9,2,2,2h1v3l3-3h5c1.1,0,2-0.9,2-2v-1.82  c-0.064,0.014-0.132,0.021-0.2,0.021h-7V12.2z M18,1H9C7.9,1,7,1.9,7,3v8h7l3,3v-3h1c1.1,0,2-0.899,2-2V3C20,1.9,19.1,1,18,1z" />
        </svg>
      </div>
    </div>
    ...
    <div class="bg-background-primary hover:text-copy-primary px-8 text-copy-secondary py-4 mb-3 cursor-default">
      ...
      <div class="flex flex-row w-full mb-3 justify-around">
        <button type="button"
          class="approvalBtn border bg-background-secondary text-copy-secondary py-2 px-4 rounded hover:bg-background-primary font-bold"
          data-id="{{ $comment->id }}">Approve</button>
        <button type="button"
          class="deleteBtn border bg-background-secondary text-copy-secondary py-2 px-4 rounded hover:bg-background-primary font-bold"
    ...
    @if(count($approved) > 0)
    <div
      class="my-4 flex flex-col justify-center items-center text-copy-primary hover:text-copy-secondary cursor-pointer w-auto">
      <p
        class="text-xl font-bold text-copy-primary {{ $settings->font_pref == 'asa' ? 'font-alegreya-sans-sc' : '' }} {{ $settings->font_pref == 'ase' ? 'font-alegreya-sc' : '' }}">
        Approved</p>
      <div class="flex flex-row mt-2">
    ...
    <div class="bg-background-primary hover:text-copy-primary px-8 text-copy-secondary py-4 mb-3 cursor-default">
      ...
      <div class="flex flex-row w-full mb-3 justify-around">
        <button type="button"
          class="unapprovalBtn border bg-background-secondary text-copy-secondary py-2 px-4 rounded hover:bg-background-primary font-bold"
          data-id="{{ $comment->id }}">Unapprove</button>
        <button type="button"
          class="deleteBtn border bg-background-secondary text-copy-secondary py-2 px-4 rounded hover:bg-background-primary font-bold"
          data-id="{{ $comment->id }}">Delete</button>
      </div>
