    ...
    <main class="lg:w-4/5">
      <section class="py-10 px-10 select-none font-serif">
        ...
        <p class="text-xl text-copy-secondary mt-4 md:px-12 md:mr-4 leading-relaxed">
          ArachniCMS is a versatile blogging platform designed to enhance your experience of publishing and operating a website. Naturally, the standard blogging tools are available to you.
        </p>
        <p class="text-xl text-copy-secondary mt-4 md:px-12 md:mr-4 leading-relaxed">
