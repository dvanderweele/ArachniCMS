...
@section('content')
  <div class="max-w-2xl w-10/12 bg-background-primary shadow-lg rounded mx-auto px-8 pt-6 pb-8 mt-8 font-sans">
    ...
    <form action="/contact" method="post">
      ...
      <div class="mb-4">
        <label for="contact_body" class="block text-copy-primary text-sm font-bold mb-2">
          Message (max: 2000 characters)
        </label>
        <textarea name="contact_body" id="contact_body" placeholder="I'm your biggest fan!" class="text-copy-primary bg-background-form shadow appearance-none border rounded w-full py-2 px-3 text-copy-primary leading-tight focus:outline-none focus:shadow-outline focus:bg-background-ruthieslight @error('contact_body') border-solid border-red-600 border-2 @enderror" required>{{ old('contact_body') }}</textarea>
      </div>
